...
scale_adjusted <- function() {
  list(
    ...
    ggplot2::scale_shape_manual(drop = FALSE, values = c("unadjusted" = 19, "adjusted" = 15,"exposure" = 17, "outcome" = 17 )),
    ggplot2::scale_alpha_manual(drop = FALSE, values = c("adjusted" = .30, "unadjusted" = 1,"exposure" = 1, "outcome" = 1)),
    ggraph::scale_edge_alpha_manual(name = NULL, drop = FALSE, values = c("adjusted" = .30, "unadjusted" = 1,"exposure" = 1, "outcome" = 1))
  )
}
